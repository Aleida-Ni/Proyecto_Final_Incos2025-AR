...
<html lang="es">
    <head>
        ...
        <style>
            ...
            .discount-card {
                position: relative;
                background: linear-gradient(135deg, #004488, #00aaff);
                border-radius: 20px;
                width: 200px;
                padding: 20px;
                color: #fff;
                ...
                cursor: pointer;
                box-shadow: 0 4px 10px rgba(0, 170, 255, 0.6), 0 0 15px rgba(0, 255, 255, 0.5);
            }

            .discount-card:hover {
                transform: translateY(-10px) scale(1.05);
                box-shadow: 0 8px 25px rgba(0, 255, 255, 0.9), 0 0 30px rgba(0, 255, 255, 0.7);
            }
            ...
            .discount-card:nth-child(4) { animation-delay: 0.7s; }
            ...
            .footer-top {
                display: flex;
                justify-content: space-between; /* redes izquierda, copyright centro, dirección derecha */
                align-items: center;
                flex-wrap: wrap;
                gap: 20px;
            }
            ...
            .direccion-footer a svg {
                width: 32px;   /* mismo tamaño para todos */
                height: 32px;
                fill: currentColor;
            }
            .redes-footer a svg {
