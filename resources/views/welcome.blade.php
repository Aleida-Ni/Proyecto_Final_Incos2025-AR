...
<head>
    ...
    <style>
        ...
        .logo-container img {
            ...
            max-height: 160px;
            filter:
                drop-shadow(0 0 8px #00aaff) drop-shadow(0 0 14px #0077cc) drop-shadow(0 0 28px #00ccff);
            transition: filter 0.3s ease;
        }

        .logo-container img:hover {
            filter:
                drop-shadow(0 0 14px #00c0ff) drop-shadow(0 0 28px #0099ee) drop-shadow(0 0 40px #00e5ff);
        }
...
.spinner {
    width: 100%;
    height: 100%;
    position: relative;   /* ✅ se mantiene dentro del carrusel */
